...
export const ChatBox = () => {
  ...
  const loadingchanneid = useSelector(
    (state: any) => state.Chats.loadingchanneid
  );
                          ...
                          <div className="flex items-center p-1">
                            ...
                            <div className="flex-shrink-0 pl-4">
                              <div className="flex flex-wrap w-10 justify-center  items-center">
                                ...
                                <p className="rounded-full text-gray-500  flex items-center justify-center  bg-gray-300 w-5 h-5">
                          ...
                          <div className="bg-gray-300">
                            {
                              <>
                                <GroupChat
                                  loading={loadingchanneid}
                                  submitChatSuccess={submitChatSuccess}
                                />
                              </>
                            }
                          </div>
