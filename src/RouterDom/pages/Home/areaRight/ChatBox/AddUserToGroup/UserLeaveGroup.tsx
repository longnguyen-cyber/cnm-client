...
export const UserLeaveGroup: FunctionComponent<any> = ({
  openLeaveGroup,
  setOpenLeaveGroup,
  selectedChat,
  user,
}) => {
  const findeOjectUser = selectedChat.users.find(
        ...
        >
          <Form onFinish={handleSubmit}>
            ...
            <Form.Item>
              <button
                type="submit"
                className="ant-btn text-white bg-blue-500 w-full p-2 rounded-md  ant-btn-primary"
              >
